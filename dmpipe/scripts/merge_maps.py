...
if __name__ == '__main__':
    ...
    parser.add_argument('--ibin', type=int, default=None, help="Extract data for this bin")
    ...
    wcs_gc = wcs_utils.create_wcs(skydir_gc,coordsys='GAL',projection=args.proj,cdelt=args.size,crpix=crpix)
    ...
    kwargs = dict(hdu=args.extname,
                  nbin=args.nbin,
                  ibin=args.ibin)

    # extract the data
    out_array = roi_set.extract_map_data(npix,sky_crds,args.filestr,
